...
/// Terms of Service — scrollable legal text.
...
class TermsScreen extends StatelessWidget {
  ...
  const TermsScreen({super.key, this.content, this.lastUpdated});
              ...
              Padding(
                ...
                child: Row(
                  children: const [
                    OzziBackButton(),
                    SizedBox(width: 12),
                    Text('Terms of Service', style: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w600)),
                  ],
                ),
              ),
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        content ?? 'Terms of service content will appear here once loaded from the backend.',
